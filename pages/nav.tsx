    ...
    <nav className="bg-white shadow">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
              <a href={'/'}className={`px-3 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 hover:underline transition-colors ease-in-out duration-150 ${router.pathname === '/' ? 'underline' : ''}`}>
                HOME
              </a>
